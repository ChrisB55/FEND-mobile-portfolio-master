...
function updatePositions() {
    ...
    for (i = 0; i < l; i++) {
        ...
        items[i].style.transform = 'translateX(' + (items[i].basicLeft + 100) * phase + 'px' + ')'; // Tips FPS Webcast suggestion. This partifular reconfiguration was suggested by Karol in the forms. -CB
    }
}
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    for (var i = 0; i < 24; i++) {
        ...
        document.getElementById("movingPizzas1").appendChild(elem); //querySelector replacedCB
    }

    window.items = document.getElementsByClassName('mover');
    updatePositions();
    //querySelector replaced. Position changed. -CB
